          ...
          <div style={{ position: 'relative' }}>
            ...
            {showAppearanceMenu && (
              <>
                ...
                {/* Appearance Menu Popover Card */}
                <div
                  className="appearance-menu-card"
                  style={{
                    position: 'absolute',
                    top: '100%',
                    right: 0,
                ...
                >
                  <h4 style={{ margin: 0, fontSize: '13px', fontWeight: 600, color: 'var(--text-primary)', borderBottom: '1px solid var(--border-color)', paddingBottom: '8px' }}>
                    Appearance &amp; Typography
                  </h4>

                  {/* Body Font */}
                  <div>
                    <label style={{ display: 'block', fontSize: '11px', color: 'var(--text-secondary)', marginBottom: '6px' }}>Body Font</label>
                    <select
                      className="select"
                  ...
                  {/* Header / Display Font */}
                  <div>
                    <label style={{ display: 'block', fontSize: '11px', color: 'var(--text-secondary)', marginBottom: '6px' }}>Chapter Headers</label>
                    <select
                      className="select"
                      style={{ width: '100%', padding: '6px', fontSize: '12px' }}
                      value={headerFont}
                  ...
                  <div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      ...
                      />
                      <span style={{ fontSize: '15px', color: 'var(--text-secondary)' }}>A</span>
                    </div>
                  </div>

                  {/* Line Spacing */}
                  <div>
                    <label style={{ display: 'block', fontSize: '11px', color: 'var(--text-secondary)', marginBottom: '6px' }}>Line Spacing</label>
                    <div style={{ display: 'flex', gap: '4px' }}>
                      {[1.2, 1.5, 1.65, 1.8, 2.1].map((val) => (
                        <button
                          ...
                          style={{ flexGrow: 1, padding: '4px 0', fontSize: '10px' }}
                  ...
                  <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                      <label style={{ fontSize: '11px', color: 'var(--text-secondary)' }}>Paragraph Spacing</label>
                  ...
                  <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                      <label style={{ fontSize: '11px', color: 'var(--text-secondary)' }}>Letter Spacing</label>
                  ...
                  <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                      <label style={{ fontSize: '11px', color: 'var(--text-secondary)' }}>Page Height</label>
                  ...
                  <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px' }}>
                      <label style={{ fontSize: '11px', color: 'var(--text-secondary)' }}>Page Margins</label>
                  ...
                  {/* Editor Width */}
                  <div>
                    <label style={{ display: 'block', fontSize: '11px', color: 'var(--text-secondary)', marginBottom: '6px' }}>Editor Width</label>
                    <div style={{ display: 'flex', gap: '4px' }}>
                      {(['narrow', 'medium', 'wide'] as EditorWidth[]).map((w) => (
                        <button
                          key={w}
                          type="button"
                          className={`btn btn-secondary ${editorWidth === w ? 'btn-primary' : ''}`}
                          style={{ flexGrow: 1, padding: '4px 0', fontSize: '11px', textTransform: 'capitalize' }}
                          onClick={() => onSetEditorWidth(w)}
                        >
                          {w}
                        </button>
                      ))}
